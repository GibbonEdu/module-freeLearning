...
if (isActionAccessible($guid, $connection2, "/modules/Free Learning/units_manage_edit.php")==FALSE) {
	...
	if ($highestAction==FALSE) {
		...
		if (strpos($freeLearningUnitID,"-")==FALSE) {
			$hooked=FALSE ;
		}
		else {
			$hooked=TRUE ;
			$gibbonHookIDToken=substr($freeLearningUnitID,11) ;
			$freeLearningUnitIDToken=substr($freeLearningUnitID,0,10) ;
		}
				...
				if ($result->rowCount()!=1) {
					...
					if ($freeLearningUnitID=="") {
						...
						try {
							...
							$sql="SELECT gibbonCourse.nameShort AS courseName, gibbonCourse.gibbonDepartmentID, freeLearningUnit.* FROM freeLearningUnit JOIN gibbonCourse ON (freeLearningUnit.gibbonCourseID=gibbonCourse.gibbonCourseID) WHERE freeLearningUnitID=:freeLearningUnitID AND freeLearningUnit.gibbonCourseID=:gibbonCourseID" ;
							$result=$connection2->prepare($sql);
							$result->execute($data);
						}
						catch(PDOException $e) { 
						...
						if ($result->rowCount()!=1) {
							...
							?>
							<form method="post" action="<?php print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/units_editProcess.php?freeLearningUnitID=$freeLearningUnitID&&address=" . $_GET["q"] ?>" enctype="multipart/form-data">
								<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
									...
									<tr id="embeddableRow" <?php if ($row["embeddable"]=="N") { print "style='display: none'" ; } ?>>
										...
										<td class="right">
											<textarea readonly name='embedCode' id='embedCode' rows=5 style='width: 300px'><?php print "<iframe style='border: none; width: 620px; height: 800px; overflow-x: hidden; overflow-y: scroll' src=\"" . $_SESSION[$guid]["absoluteURL"] . "/modules/Free Learning/units_manage_embed.php?freeLearningUnitID=$freeLearningUnitID&&themeName=" . $_SESSION[$guid]["gibbonThemeName"] . "&title=false\"></iframe>" ?></textarea>
										</td>
									</tr>
															...
															<td style='width: 50%'>
																...
																<select class='all' id='newOutcome' onChange='outcomeDisplayElements(this.value);' style='float: none; margin-left: 3px; margin-top: 0px; margin-bottom: 3px; width: 350px'>
																	...
																	while ($rowSelect=$resultSelect->fetch()) {
																		...
																		$switchContents.="$(\"#outcomeOuter\" + outcomeCount).load(\"" . $_SESSION[$guid]["absoluteURL"] . "/modules/Free Learning/units_manage_add_blockOutcomeAjax.php\",\"type=outcome&id=\" + outcomeCount + \"&title=" . urlencode($rowSelect["name"]) . "\&category=" . urlencode($rowSelect["category"]) . "&gibbonOutcomeID=" . $rowSelect["gibbonOutcomeID"] . "&contents=" . urlencode($rowSelect["description"]) . "&allowOutcomeEditing=" . urlencode($allowOutcomeEditing) . "\") ;" ;
												...
												if ($resultClass->rowCount()<1) {
													...
													print "<table cellspacing='0' style='width: 100%'>" ;
														...
														while ($rowClass=$resultClass->fetch()) {
															...
															try {
																$dataClassData=array("freeLearningUnitID"=>$freeLearningUnitID, "gibbonCourseClassID"=>$rowClass["gibbonCourseClassID"]); 
																$sqlClassData="SELECT * FROM freeLearningUnitClass WHERE freeLearningUnitID=:freeLearningUnitID AND gibbonCourseClassID=:gibbonCourseClassID" ;
															...
															print "<tr class=$rowNum>" ;
																...
																print "<td>" ;
																	try {
																		$dataDate=array("gibbonCourseClassID"=>$rowClass["gibbonCourseClassID"], "freeLearningUnitID"=>$freeLearningUnitID); 
																		$sqlDate="SELECT date FROM gibbonPlannerEntry WHERE gibbonCourseClassID=:gibbonCourseClassID AND freeLearningUnitID=:freeLearningUnitID ORDER BY date, timeStart" ;
																...
																print "<td>" ;
																	if ($rowClassData["running"]=="Y") {
																		if ($resultDate->rowCount()<1) {
																			print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_deploy.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClassData["freeLearningUnitClassID"] . "'><img title='Edit Unit' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/config.png'/></a> " ;
																		}
																		else {
																			print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_working.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClassData["freeLearningUnitClassID"] . "'><img title='Edit Unit' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/config.png'/></a> " ;
																		}
																		...
																		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_copyBack.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClassData["freeLearningUnitClassID"] . "'><img title='Copy Back' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/copyback.png'/></a> " ;
																		print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_copyForward.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClassData["freeLearningUnitClassID"] . "'><img title='Copy Forward' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/copyforward.png'/></a> " ;
																	}
																print "</td>" ;
															print "</tr>" ;
															$classCount++ ;
									...
									<tr>
										<td colspan=2>
											...
											<div class="sortable" id="sortable" style='width: 100%; padding: 5px 0px 0px 0px'>
												...
												try {
													$dataOutcomes=array("freeLearningUnitID"=>$freeLearningUnitID); 
													$sqlOutcomes="SELECT gibbonOutcome.gibbonOutcomeID, gibbonOutcome.name, gibbonOutcome.category, scope, gibbonDepartment.name AS department FROM freeLearningUnitOutcome JOIN gibbonOutcome ON (freeLearningUnitOutcome.gibbonOutcomeID=gibbonOutcome.gibbonOutcomeID) LEFT JOIN gibbonDepartment ON (gibbonOutcome.gibbonDepartmentID=gibbonDepartment.gibbonDepartmentID) WHERE freeLearningUnitID=:freeLearningUnitID AND active='Y' ORDER BY sequenceNumber" ;
												...
												$i=1 ;
												while ($rowBlocks=$resultBlocks->fetch()) {
													makeBlock($guid, $connection2, $i, "masterEdit", $rowBlocks["title"], $rowBlocks["type"], $rowBlocks["length"], $rowBlocks["contents"], "N", $rowBlocks["freeLearningUnitBlockID"], "", $rowBlocks["teachersNotes"], TRUE, $unitOutcomes, $rowBlocks["gibbonOutcomeIDList"]) ;
													$i++ ;
												}
												?>
											</div>
																...
																<script type="text/javascript">
																	...
																	$(document).ready(function(){
																		$("#new").click(function(){
																			...
																			$("#blockOuter" + count).load("<?php print $_SESSION[$guid]["absoluteURL"] ?>/modules/Free Learning/units_manage_add_blockAjax.php","id=" + count + "&mode=masterEdit") ;
																			count++ ;
																		 });
																	});
																</script>
					...
					if ($gibbonHookIDToken=="") {
						...
						if ($resultHooks->rowCount()==1) {
							...
							if ($hookOptions["unitTable"]!="" AND $hookOptions["unitIDField"]!="" AND $hookOptions["unitCourseIDField"]!="" AND $hookOptions["unitNameField"]!="" AND $hookOptions["unitDescriptionField"]!="" AND $hookOptions["classLinkTable"]!="" AND $hookOptions["classLinkJoinFieldUnit"]!="" AND $hookOptions["classLinkJoinFieldClass"]!="" AND $hookOptions["classLinkIDField"]!="") {
								try {
									$data=array("unitIDField"=>$freeLearningUnitIDToken); 
											...
											print "<table cellspacing='0' style='width: 100%'>" ;
												...
												while ($rowClass=$resultClass->fetch()) {
													...
													print "<tr class=$rowNum>" ;
														...
														print "<td>" ;
															try {
																$dataDate=array("gibbonCourseClassID"=>$rowClass["gibbonCourseClassID"], "gibbonHookID"=>$gibbonHookIDToken, "freeLearningUnitID"=>$freeLearningUnitIDToken); 
																$sqlDate="SELECT date FROM gibbonPlannerEntry WHERE gibbonCourseClassID=:gibbonCourseClassID AND gibbonHookID=:gibbonHookID AND freeLearningUnitID=:freeLearningUnitID ORDER BY date, timeStart" ;
																$resultDate=$connection2->prepare($sqlDate);
																$resultDate->execute($dataDate);
															}
															catch(PDOException $e) { }
														...
														print "<td>" ;
															if ($resultDate->rowCount()<1) {
																print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_deploy.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClass[$hookOptions["classLinkIDField"]] . "'><img title='Edit Unit' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/config.png'/></a> " ;
															}
															else {
																print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/units_edit_working.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&gibbonCourseID=$gibbonCourseID&freeLearningUnitID=$freeLearningUnitID&gibbonSchoolYearID=$gibbonSchoolYearID&freeLearningUnitClassID=" . $rowClass[$hookOptions["classLinkIDField"]] . "'><img title='Edit Unit' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/config.png'/></a> " ;
															}
															print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/" . $_SESSION[$guid]["module"] . "/planner.php&gibbonCourseClassID=" . $rowClass["gibbonCourseClassID"] . "&viewBy=class'><img style='margin-top: 3px' title='" . _('View Planner') . "' src='./themes/" . $_SESSION[$guid]["gibbonThemeName"] . "/img/planner.png'/></a> " ;
														print "</td>" ;
													print "</tr>" ;
