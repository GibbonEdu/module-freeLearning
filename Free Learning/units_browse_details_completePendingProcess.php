                            ...
                            if ($schoolType == 'Online') {
                                ...
                                if ($enrolmentMethod == 'class') { //Attempt to notify teacher(s) of class
                                    ...
                                    if ($emailMentor != '') {
                                        ...
                                        $body .= sprintf(__($guid, 'The following %1$s at %2$s has requested your feedback on their %3$sFree Learning%4$s work, which they have just submitted, and on which you previously agreed to mentor them.'), $roleCategoryFull, $_SESSION[$guid]['systemName'], "<a target='_blank' href='https://rossparker.org'>", '</a>');
                                        $body .= '<br/>';
                                        $body .= '<ul>';
