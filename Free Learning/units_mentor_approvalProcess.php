...
//Set return URL
$URL = Url::fromModuleRoute('Free Learning', 'units_mentor_approval')->withQueryParams(["sidebar" => "true", "freeLearningUnitStudentID" => $freeLearningUnitStudentID, "confirmationKey" => $confirmationKey]);
            ...
            if ($status == 'Complete - Approved') { //APPROVED!
                ...
                if ($enableManualBadges == 'Y' && isModuleAccessible($guid, $connection2, '/modules/Badges/badges_grant.php') && !empty($badgesBadgeID)) {
                    ...
                    foreach ($collaborators as $collaborator) {
                        ...
                        //Notify User
                        $notificationSender->addNotification($collaborator['gibbonPersonIDStudent'], $notificationText, 'Badges', $actionLink);
                    }
