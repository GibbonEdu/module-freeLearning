		...
		<table cellspacing='0' style="width: 100%">	
			...
			while ($rowClass=$resultClass->fetch()) {
				...
				?>
					...
					<td> 
						<?php
							print "<a href='" . $_SESSION[$guid]["absoluteURL"] . "/index.php?q=/modules/Free Learning/units_browse_details.php&freeLearningUnitID=" . $rowClass["freeLearningUnitID"] . "&tab=1'>" . $rowClass["unit"] . "</a>" ;
						?>
					</td>	
					<td> 
