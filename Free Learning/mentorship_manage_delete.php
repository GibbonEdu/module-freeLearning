...
if (isActionAccessible($guid, $connection2, '/modules/Free Learning/mentorship_manage_delete.php') == false) {
    ...
    $result = $container->get(MentorshipGateway::class)->selectBy(['gibbonPersonIDStudent' => $gibbonPersonIDStudent]);
    ...
    $form = DeleteForm::createForm($gibbon->session->get('absoluteURL').'/modules/Free Learning/mentorship_manage_deleteProcess.php');
    echo $form->getOutput();
}
