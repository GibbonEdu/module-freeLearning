...
INSERT INTO `gibbonAction` (`gibbonActionID`, `gibbonModuleID`, `name`, `precedence`, `category`, `description`, `URLList`, `entryURL`, `entrySidebar`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) VALUES (NULL, (SELECT gibbonModuleID FROM gibbonModule WHERE name='Free Learning'), 'Mentorship Overview_my', 0, 'Reports', 'Allows a user to see units which they are a mentor.', 'report_mentorshipOverview.php','report_mentorshipOverview.php', 'Y', 'N', 'Y', 'N', 'N', 'N', 'Y', 'N', 'N', 'N');end
...
INSERT INTO `gibbonAction` (`gibbonActionID`, `gibbonModuleID`, `name`, `precedence`, `category`, `description`, `URLList`, `entryURL`, `entrySidebar`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) VALUES (NULL, (SELECT gibbonModuleID FROM gibbonModule WHERE name='Free Learning'), 'Manage Mentorship', 0, 'Admin', 'Allows a user to manually assign mentorship for students.', 'mentorship_manage.php,mentorship_manage_add.php,mentorship_manage.php,mentorship_manage_edit.php','mentorship_manage_delete.php', 'Y', 'Y', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N');end
INSERT INTO `gibbonPermission` (`gibbonRoleID` ,`gibbonActionID`) VALUES (001, (SELECT gibbonActionID FROM gibbonAction JOIN gibbonModule ON (gibbonAction.gibbonModuleID=gibbonModule.gibbonModuleID) WHERE gibbonModule.name='Free Learning' AND gibbonAction.name='Manage Mentorship'));end
CREATE TABLE `freeLearningMentorship` ( `freeLearningMentorshipID` INT(12) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT , `gibbonPersonIDStudent` INT(10) UNSIGNED ZEROFILL NOT NULL , `gibbonPersonIDSchoolMentor` INT(10) UNSIGNED ZEROFILL NOT NULL , PRIMARY KEY (`freeLearningMentorshipID`), UNIQUE KEY `gibbonPersonIDStudent` (`gibbonPersonIDStudent`,`gibbonPersonIDSchoolMentor`)) DEFAULT CHARSET=utf8 ENGINE = InnoDB;end
";
